<script lang="ts">
import FluentLockClosed24Filled from "virtual:icons/fluent/lock-closed-24-filled";
import FluentLockClosed24Regular from "virtual:icons/fluent/lock-closed-24-regular";
