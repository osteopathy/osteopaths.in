<script lang="ts">
import FluentMailInbox24Filled from "virtual:icons/fluent/mail-inbox-24-filled";
import FluentMailInbox24Regular from "virtual:icons/fluent/mail-inbox-24-regular";
