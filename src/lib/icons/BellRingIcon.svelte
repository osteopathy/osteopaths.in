<script lang="ts">
import FluentAlertOn24Filled from "virtual:icons/fluent/alert-on-24-filled";
import FluentAlertOn24Regular from "virtual:icons/fluent/alert-on-24-regular";
