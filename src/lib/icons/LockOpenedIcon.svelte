<script lang="ts">
import FluentLockOpen24Filled from "virtual:icons/fluent/lock-open-24-filled";
import FluentLockOpen24Regular from "virtual:icons/fluent/lock-open-24-regular";
