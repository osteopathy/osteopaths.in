<script lang="ts">
import FluentArrowRight24Filled from "virtual:icons/fluent/arrow-right-24-filled";
import FluentArrowRight24Regular from "virtual:icons/fluent/arrow-right-24-regular";
