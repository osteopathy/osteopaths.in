// copied from packages/create-astro/src/messages.ts
...
export const banner = (
	...
	suffix: string = `Launch sequence initiated.`
) => {
	log(`${label(prefix, color.bgYellow, color.black)}  ${suffix}`);
};

export const bannerAbort = (
	prefix: string = "Deployment",
	suffix: string = "Launch sequence aborted."
) => log(`\n${label(prefix, color.bgRed)} ${color.bold(suffix)}`);
