<script lang="ts">
import FluentMailInboxAll24Filled from "virtual:icons/fluent/mail-inbox-all-24-filled";
import FluentMailInboxAll24Regular from "virtual:icons/fluent/mail-inbox-all-24-regular";
