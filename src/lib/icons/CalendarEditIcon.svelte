<script lang="ts">
import FluentCalendarEdit32Filled from "virtual:icons/fluent/calendar-edit-32-filled";
import FluentCalendarEdit32Regular from "virtual:icons/fluent/calendar-edit-32-regular";
