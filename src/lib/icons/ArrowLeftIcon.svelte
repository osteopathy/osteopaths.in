<script lang="ts">
import FluentArrowLeft24Filled from "virtual:icons/fluent/arrow-left-24-filled";
import FluentArrowLeft24Regular from "virtual:icons/fluent/arrow-left-24-regular";
