<script lang="ts">
import FluentUpload24Filled from "virtual:icons/fluent/upload-24-filled";
import FluentUpload24Regular from "virtual:icons/fluent/upload-24-regular";
